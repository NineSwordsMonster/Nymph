...
import com.ninesward.nymph.IJoyStickPresenter;
import com.ninesward.nymph.R;
import com.ninesward.nymph.util.ScreenUtils;
...
public class JoyStickView extends FrameLayout {
    ...
    public JoyStickView(Context context) {
        ...
        findViewById(R.id.btn_bookmark).setOnLongClickListener(new View.OnLongClickListener() {
            @Override
