...
//            try {
//                mMethodMakeComplete = Location.class.getMethod("makeComplete");
...
//                mILocationManager = (ILocationManager.Stub) declaredField.get(mLocationManager);
//            } catch (Exception e) {
...
//                if (mLastLocPoint.getLatitude() != locPoint.getLatitude() || mLastLocPoint.getLongitude() != locPoint.getLongitude()) {
